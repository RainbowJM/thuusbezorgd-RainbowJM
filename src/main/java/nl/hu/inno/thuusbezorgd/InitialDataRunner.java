...
import nl.hu.inno.thuusbezorgd.security.DbUser;
...
public class InitialDataRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        this.entities.persist(new DbUser("admin", "admin"));
        this.entities.persist(new DbUser("tom", "Tom123"));
        this.entities.persist(new DbUser("mirko", "Mirko456"));
        this.entities.persist(new DbUser("robin", "0fir%%cQJ|Rc!!=&fIKsRI"));
