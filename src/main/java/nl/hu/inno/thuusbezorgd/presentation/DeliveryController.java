...
public class DeliveryController {
    ...
    public DeliveryController(DeliveryService deliveryService, DeliveryRepository deliveries, UserRepository users, ReviewRepository reviews) {
    ...
    @GetMapping
    public List<DeliveryResponseDTO> deliveries(Principal principal) {
    ...
    @GetMapping("{id}")
    public ResponseEntity<DeliveryResponseDTO> getDelivery(Principal principal, @PathVariable long id) {
        BaseUser user = users.findById(principal.getName()).orElseThrow();
